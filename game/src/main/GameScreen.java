...
public class GameScreen extends JFrame{
	...
	private Game game;
	private BufferedImage chick, cat, target, targetSmall, eggRight, eggLeft, background;
	...
	public GameScreen(){
		...
		game= new Game(chick,cat,target,targetSmall,eggRight,eggLeft,background);
		game.requestFocus();
	...
	private void importImg() {
		...
		is = getClass().getResourceAsStream("/targetSmall.png");
		try {
			targetSmall = ImageIO.read(is);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
