...
public class Game extends JPanel implements KeyListener, ActionListener{
	...
	private BufferedImage chickImg, catImg,targetImg, eggRight,eggLeft, background;//The images of game
	...
	//Constructor of game 
	public Game(BufferedImage chickImg, BufferedImage catImage, BufferedImage targetImage, BufferedImage eggRight,BufferedImage eggLeft, BufferedImage background) {
	...
	public void paint(Graphics g) {//Paints the objects in each game loop
		...
		if(!isGameStarted) {
			...
			g.drawString("And of course don't get caught by the cats!", 300, 270);
			g.drawString("Press s to start game. Have fun!", 330, 300);
		}
		else {
